...
@section('title') Change Profile Picture - Student Grading System @endsection
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-8">
          ...
          <form action="{{ route('post_profile_picture_change') }}" method="POST" enctype="multipart/form-data">
