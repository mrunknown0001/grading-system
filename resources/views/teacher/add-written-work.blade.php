...
@include('teacher.teacher-menu')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Add Written Work : {{ ucwords($assign->subject->grade_level->name) }} - {{ ucwords($assign->section->name) }} - {{ ucwords($assign->subject->title) }}
        ...
        <div class="col-md-8">
          ...
          <form action="{{ route('post_add_written_work_score') }}" method="POST" autocomplete="off">
            <div class="form-group">
              <input type="number" name="total" max=999 onkeypress='return event.charCode >= 48 && event.charCode <= 57' placeholder="Total" id="total" />
            </div>
            <div class="form-group">
