...
@section('title') Teacher Change Profile Picture - Student Grading System @endsection
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-8">
          ...
          <form action="{{ route('post_teacher_change_profile_picture') }}" method="POST" enctype="multipart/form-data">
